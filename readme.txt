...
1.1) Recommended Configurations
...
2) Software Specifications & Requirements
...
7) How to install the modules and packages in Python?
...
8) How to install the plugins in QGIS?
...
5. After the completion of the previous step, another window would open. Go To ’Install
from ZIP’
...
(d) Dataset Source - Chicago Police Department’s CLEAR (Citizen Law Enforcement
Analysis and Reporting) system - https://data.cityofchicago.org/Public-Safety/Crimes-
2001-to-present/ijzp-q8t2
(e) Dataset Avalaibility - Publicly Available for free


*** Other details are available in the project report ***
